        ...
        if boolThreeD
            ...
            if options.hertzian
                save(strFilename, 'vecPosX', 'vecPosY', 'vecPosZ', 'vecDiameter', ...
                    'scalBoxWidthX', 'scalBoxHeightY', 'scalBoxDepthZ', ...
                    'K', 'P_target', 'scalPressure', 'N', 'N_original', 'scalPackingFraction', ...
                    'vecHertzNN', 'vecHertzMM', 'vecHertzKeff', 'boolFrictionOn', 'scalMu', 'scalKt');
            else
                save(strFilename, 'vecPosX', 'vecPosY', 'vecPosZ', 'vecDiameter', ...
                    'scalBoxWidthX', 'scalBoxHeightY', 'scalBoxDepthZ', ...
                    'K', 'P_target', 'scalPressure', 'N', 'N_original', 'scalPackingFraction', 'boolFrictionOn', 'scalMu', 'scalKt');
            end
        else
            matPositions = [vecPosX, vecPosY];
            vecRadii = vecDiameter ./ 2;
            ...
            if options.hertzian
                save(strFilename, 'vecPosX', 'vecPosY', 'vecDiameter', ...
                    ...
                    'scalPackingFraction', 'matEigenVectors', 'matEigenValues', ...
                    'vecHertzNN', 'vecHertzMM', 'vecHertzKeff', 'boolFrictionOn', 'scalMu', 'scalKt');
            else
                save(strFilename, 'vecPosX', 'vecPosY', 'vecDiameter', ...
                    'scalBoxWidthX', 'scalBoxHeightY', 'K', 'P_target', 'scalPressure', 'N', 'N_original', ...
                    'scalPackingFraction', 'matEigenVectors', 'matEigenValues', 'boolFrictionOn', 'scalMu', 'scalKt');
            end
        end
    else
        if boolThreeD
            ...
            if options.hertzian
                save(strFilename, 'vecPosX', 'vecPosY', 'vecDiameter', ...
                    ...
                    'N', 'N_original', 'scalPackingFraction', ...
                    'vecHertzNN', 'vecHertzMM', 'vecHertzKeff', 'boolFrictionOn', 'scalMu', 'scalKt');
            else
                save(strFilename, 'vecPosX', 'vecPosY', 'vecDiameter', ...
                    'scalBoxWidthX', 'scalBoxHeightY', 'K', 'P_target', 'scalPressure', ...
                    'N', 'N_original', 'scalPackingFraction', 'boolFrictionOn', 'scalMu', 'scalKt');
            end
        end
    end
